...
let commands: ICommand[] = [
    { id: 'extension.escapeJsonString', mode: MODE.EscapeJsonString },
    { id: 'extension.unescapeJsonString', mode: MODE.UnescapeJsonString },
];
...
export function activate(context: vscode.ExtensionContext) {
    ...
    //console.log('Congratulations, your extension "json-escaper" is now active!');
